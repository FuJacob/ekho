...
import NavAccountSection from "@/components/NavAccountSection";
export default function Home() {
  return (
    <>
      <header className="flex justify-between items-center p-6 gap-4 h-36 text-2xl">
        <Link href="/">Ekho</Link>
      ...
      <main className="flex flex-col items-center justify-center min-h-screen">
        ...
        <div className="h-[800px] flex items-center">
          <section className="w-[1000px] h-[500px] flex flex-row gap-12">
            <div className="flex flex-col items-center justify-center gap-12 text-center w-1/3">
              ...
              <p>
                Bland provides fully self-hosted, end-to-end infrastructure.
                That means faster response times, 99.99% uptime, and guaranteed
            ...
            <div className="grid grid-cols-2 gap-8 w-2/3 text-white">
              <div className="bg-black rounded-2xl p-6">
                ...
                <p className="mt-12">
                  Provide your agent with sample dialogue and relevant details
                  to personalize interactions with your customers.
                </p>
              </div>
        ...
        <footer className="my-12 text-white rounded-3xl p-12 text-2xl font-bold space-x-12 flex flex-col w-full bg-primary justify-between h-96">
          <div className="flex flex-row justify-between">
            <h1 className="text-5xl">Ekho</h1>
            <Link
